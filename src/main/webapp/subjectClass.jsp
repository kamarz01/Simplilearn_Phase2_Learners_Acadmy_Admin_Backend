...
<head>
    ...
    <title>Subject/Classes - Zaghloul Academy</title>
</head>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Assign Subjects to Classes</h3>
            </div>
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <c:forEach items="${requestScope.classList}" var="_class">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${_class.subjects.size() > 0}">
                                        <table>
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                            ...
                                            <tr>
                                                <span style="display: none" class="subjectId_${_class.classId}">${subject.subjectId}</span>
...
<div class="modal fade" id="editAssign" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="save" method="post" action="subjectClass">
